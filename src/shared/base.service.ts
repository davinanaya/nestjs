...
export abstract class BaseService<T extends Typegoose>{
    ...
    async create(time: InstanceType<T>): Promise<T>{
        return this._model.create(time);
    }
